                        ...
                        <tbody>
                            ...
                            <?php foreach ($prodi as $us) : ?>
                                <tr>
                                    ...
                                    <td><img src="<?= base_url('assets/img/prodi/') . $user['gambar']; ?>" style="width: 100px;" class="img-thumbnail"></td>
                                    <td>
                                        <a href="<?= base_url('Prodi/hapus/') . $us['id']; ?>" class="badge badge-danger" style="color: #fff; background-color: #dc3545; text-decoration: none;">Hapus</a>
                                        <a href="<?= base_url('Prodi/edit/') . $us['id']; ?>" class="badge badge-danger" style="color: #212529; background-color: #ffc107; text-decoration: none;">Edit</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
